...
class AllPostCardWidget extends StatefulWidget {
  ...
  const AllPostCardWidget({super.key, required this.postModel});

  @override
  State<AllPostCardWidget> createState() => _AllPostCardWidgetState();
}

class _AllPostCardWidgetState extends State<AllPostCardWidget> {
  bool isLiked = false;
  bool isFav = false;
  @override
  void initState() {
